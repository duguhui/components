...
/**************************** Test ***********************************/
$mail = new MySendMail();
$mail->setServer("smtp.qq.com", "1002249052@qq.com", "myvbfmwzlljcbaih", 465, true); //到服务器的SSL连接
//如果不需要到服务器的SSL连接，这样设置服务器：$mail->setServer("smtp.126.com", "XXX@126.com", "XXX");
$mail->setFrom("1002249052@qq.com");
$mail->setReceiver("1002249052@qq.com");
// $mail->setReceiver("wangde007@outlook.com");
$mail->setCc("1002249052@qq.com");
// $mail->setCc("wangde007@outlook.com");
$mail->setBcc("1002249052@qq.com");
// $mail->setBcc("wangde007@outlook.com");
$mail->addAttachment("test.html");
// $mail->addAttachment("test.php");
// $mail->addAttachment("01.png");
$mail->setMail("test", "<b>test</b>");
$mail->sendMail();
mail('1002249052@qq.com','标题','正文');